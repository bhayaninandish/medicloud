<nav class="navbar navbar-expand-lg nav_class p-3">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto pr-4 abc">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="#whytracer">Past Prescriptions</a>
      </li>
      
      <li class="nav-item active">
        <a class="nav-link" href="#symptoms">Past Appointments</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="https://www.cowin.gov.in/">Get Vaccinated</a>
      </li>
